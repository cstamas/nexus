...
public class DirectoryFileSizeStat
    extends AbstractSampledStat<Long>
{
    ...
    public DirectoryFileSizeStat( final String name, final File directory )
    {
        this( name, directory, null );
    }

    public DirectoryFileSizeStat( final String name, final File directory, final FileFilter filter )
    {
        super( name, null );
